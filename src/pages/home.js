                ...
                <div className="container mb-5" style={{fontSize: "12pt", lineHeight:"3rem"}}>
                    ...
                    <div className="col-lg-12">
                        <p>
                            ...
                            the opposition to expose the sociopolitical systems of racism, patriarchy, and homophobia, and the opposition to allow black women to explore the textures of 
                            Black women’s lives independent of these systems. However, in the past few years, we’ve seen a ground-breaking renaissance of black female film, where such auteurs are 
                            reshaping and defining black identity and culture by resisting cultural hegemony and creating a more inclusive and representative media. By these works, it is affirmed 
                            that the images, messages, and artistry created by black female auteurs are the tools to bring forth mental liberation from prevailing ideologies rooted in white supremacy. If black women were given the same platforms, resources, and financial support as men to persuade the media, they could single-handedly revolutionize the regarding and understanding of oppressed peoples.
                        </p>
                    </div>
                </div>
            </section>
